...
|---|--------------------|----------------------------------------------------------------------------|--------|
| 1 | Security           | auth enforced; CORS locked; loopback default; dangerous ops gated          | ⬜ pending (Phase 1) |
...
| 9 | Tests              | capabilities + intent(81) + auth + autonomous-goal + route-smoke green     | 🟨 **partial** — capabilities + intent(81) green; auth/autonomous/smoke pending |
